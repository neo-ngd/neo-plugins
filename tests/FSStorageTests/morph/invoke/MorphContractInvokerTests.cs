...
namespace Neo.Plugins.FSStorage.morph.invoke.Tests
{
    ...
    public class MorphContractInvokerTests : TestKit
    {
        ...
        public void InvokeAddPeerTest()
        {
            ...
            nodeInfo.PublicKey = Google.Protobuf.ByteString.CopyFrom(key.ToArray());
        ...
        {
            var key = Utility.StrictUTF8.GetBytes("ContainerFee");
        ...
        public void InvokeSetEACLTest()
        {
            ...
            byte[] sig = Crypto.Sign(eACLTable.ToByteArray(), key.PrivateKey, key.PublicKey.EncodePoint(false)[1..]);
